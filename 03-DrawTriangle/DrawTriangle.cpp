...
public:
	...
	void Initialize() {
		...
		FCCS::RHI::Blob* vs = FCCS::RHI::CompileShaderFromFile(L"DrawTriangle.hlsl", "VSMain", "vs_5_1");
		FCCS::RHI::Blob* ps = FCCS::RHI::CompileShaderFromFile(L"DrawTriangle.hlsl", "PSMain", "ps_5_1");
